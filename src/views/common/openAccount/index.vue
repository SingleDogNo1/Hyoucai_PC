      ...
      <div class="user_reg_second">
        <div class="formBox" id="second">
          ...
          <div class="form-data">
            ...
            <p class="id-card"><i class="iconfont icon-certificate"></i><input type="text" placeholder="请输入身份证号" /></p>
            <p class="mobile">
              <i class="iconfont icon-phone1"></i>
              <input type="text" :disabled="formData.mobile.disabled" :value="formData.mobile.val" placeholder="请输入开户手机号" />
            </p>
