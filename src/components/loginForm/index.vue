  ...
  <div class="form">
    <div class="unLogin" v-if="!user">
      ...
      <div v-if="loginType === 1" class="form-sms">
        <div class="form-item">
          <i class="iconfont icon-user"></i> <input type="tel" v-model="mobile" placeholder="请输入手机号" maxlength="11" /> <span>获取验证码</span>
        </div>
        <div class="form-item"><i class="iconfont icon-validation"></i> <input type="tel" v-model="mobile" placeholder="请输入验证码" /></div>
      </div>
