  ...
  <footer class="app-footer-wrapper">
    <ul class="top">
      ...
      <li>
        ...
        <router-link :to="{ path: 'helpCenter', query: { helpCode: item.dicCode } }" v-for="(item, index) in QAList" :key="index">{{
          item.dicName
        }}</router-link>
      </li>
      <li>
    ...
    <div class="btm">
      ...
      <div class="copy-img">
        ...
        <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=36012102000103"> <img src="./gongan_wb.png" alt /> </a>
